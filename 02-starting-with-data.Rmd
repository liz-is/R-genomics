...
This displays the whole dataset, which can be many rows! Instead, we can inspect just the first 6 rows of this `data.frame` using the function `head()`:
...
>### Challenge
Using these functions, can you answer the following questions?
